<template>
  <div class="modal">
    <section class="modal_wrap">
      ...
      <form id="login_form">
        <input class="modal_input" name="user_id" type="text" placeholder="아이디" autofocus />
        <input class="modal_input" name="user_pw" type="password" placeholder="비밀번호" />
